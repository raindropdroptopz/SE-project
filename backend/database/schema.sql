...
-- ===============================================
-- ตาราง equipment_bookings (การยืมอุปกรณ์)
-- ===============================================
...
('ลูกวอลเลย์บอล', 'ลูกวอลเลย์บอลมาตรฐาน สำหรับเล่นในร่มและชายหาด', 'ลูกบอล', 6, 6, '/photo/volleyball.jpg', 'available'),
('ชุดกรวยฝึกซ้อม', 'ชุดกรวย 10 ชิ้น สำหรับการฝึกซ้อมความคล่องตัว', 'อุปกรณ์ฝึกซ้อม', 4, 4, '/photo/cones.jpg', 'available');

-- ===============================================
-- ข้อมูลเริ่มต้น: Admin User
-- ===============================================
